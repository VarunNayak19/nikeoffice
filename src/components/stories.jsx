...
import { Splide, SplideSlide } from '@splidejs/react-splide'; import '@splidejs/splide/css';
                            ...
                            <SplideSlide key={i}
                                ...
                                <div className='relative grid items-center gap-4 pb-2 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200 '>
                                    <div className=' flex items-center justify-center'>
                                        <img src={val.img} alt="img.stories"
                                    ...
                                    <div className=' flex items-center justify-between w-full px-4'>
                                        ...
                                        <div className='flex items-center gap-0.5'><HashtagIcon className='icon-style w-4 h-4 text-blue-600  ' /><span className='text-xs font-bold'>{val.by}</span></div>
                                    </div>
                                    <div className='
                                    gird items-center justify-items-start px-4 '>
